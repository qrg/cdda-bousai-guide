...
import PorterStemmerFr from '../../../node_modules/natural/lib/natural/stemmers/porter_stemmer_fr';
...
const stopwords = [
  ...
  'avait', 'avant', 'avec', 'avoir', 'avons', 'ayant', 'b', 'bah', 'bas',
  'basee', 'bat', 'beau', 'beaucoup', 'bien', 'bigre', 'boum', 'bravo', 'brrr',
  ...
  'fait', 'façon', 'feront', 'fi', 'flac', 'floc', 'font', 'g', 'gens', 'h',
  'ha', 'hein', 'hem', 'hep', 'hi', 'ho', 'holà', 'hop', 'hormis', 'hors',
  ...
  'lui', 'lui-meme', 'lui-même', 'là', 'lès', 'm', 'ma', 'maint', 'maintenant',
  'mais', 'malgre', 'malgré', 'maximale', 'me', 'meme', 'memes', 'merci', 'mes',
  'mien', 'mienne', 'miennes', 'miens', 'mille', 'mince', 'minimale', 'moi',
  'moi-meme', 'moi-même', 'moindres', 'moins', 'mon', 'moyennant', 'multiple',
  'multiples', 'même', 'mêmes', 'n', 'na', 'naturel', 'naturelle', 'naturelles',
  'ne', 'neanmoins', 'necessaire', 'necessairement', 'neuf', 'neuvième', 'ni',
  ...
  'pres', 'probable', 'probante', 'procedant', 'proche', 'près', 'psitt', 'pu',
  'puis', 'puisque', 'pur', 'pure', 'q', 'qu', 'quand', 'quant', 'quant-à-soi',
  ...
  'sacrebleu', 'sait', 'sans', 'sapristi', 'sauf', 'se', 'sein', 'seize',
...
export default {
  ...
  tokenizePatterns: [
    ...
    /([^àâäôöéèëêïîçùûüÿæœÀÂÄÔÉÈËÊÏÎŸÇÙÛÜÆŒa-zA-Z0-9&]+)/g
  ],
  ignorePatterns: [
    ...base.ignorePatterns,
    /^[àâäôöéèëêïîçùûüÿæœÀÂÄÔÉÈËÊÏÎŸÇÙÛÜÆŒ]$/,
    ...stopwords
  ],
  stemmer: PorterStemmerFr.stem
};
